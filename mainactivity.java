...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send_button = (Button)findViewById(R.id.signupbtn);
        send_text1=(EditText)findViewById(R.id.username);
        send_text2=(EditText)findViewById(R.id.age);
        send_text3=(EditText)findViewById(R.id.mobile);
        send_text4=(EditText)findViewById(R.id.location);
